...
from scripts.audit_m5_search import ROOT, validate


class Evidence(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.evidence = json.loads((ROOT/'docs/m5_search_evidence.json').read_text())
    ...
    def test_negative_gates(self):
        mutations = [
            ...
            lambda e: e['decisions'].update(lto='RETAIN'),
