"""Reject changed exact outputs, accounting, hardware, samples and cleanup."""
import copy
import json
import unittest

from scripts.audit_m5_scalar import ROOT, validate


class Evidence(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.evidence = json.loads((ROOT/'docs/m5_scalar_evidence.json').read_text())
    ...
    def test_negative_gates(self):
        mutations = [
            ...
            lambda e: e['reports']['measurement']['runs'][2].update(workspace_high_water=1632708),
            ...
            lambda e: e['decisions'].update(affine='REJECT'),
        ]
