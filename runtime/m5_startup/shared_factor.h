/* Exact parent factor product, shared out-of-line to preserve code capacity. */
...
static __attribute__((noinline, unused)) double pa_tenth_mul_factor(const pa_tenth_factor *factor, double value) {
